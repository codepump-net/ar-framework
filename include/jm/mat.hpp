...
template<typename T,size_t C, size_t R> template<typename T1,typename> mmat_t<T,C,R>::mmat_t(const T1& a) {
	...
	if constexpr ( _rows_<T1>::n ==1 && _cols_<T1>::n ==1 ) {				// is scalar
		if constexpr (C == R) {										// square matrix
			for( int i=0; i<C; i++ ) { v[i]= VecType(0); v[i][i]=a; }
		}
...
const inline float* value_ptr (const mat2& a)   { return (float*)a.v; }
const inline float* value_ptr (const mat3& a)   { return (float*)a.v; }
const inline float* value_ptr (const mat4& a)   { return (float*)a.v; }
const inline float* value_ptr (const mat2x3& a) { return (float*)a.v; }
const inline float* value_ptr (const mat2x4& a) { return (float*)a.v; }
const inline float* value_ptr (const mat3x2& a) { return (float*)a.v; }
const inline float* value_ptr (const mat3x4& a) { return (float*)a.v; }
const inline float* value_ptr (const mat4x2& a) { return (float*)a.v; }
const inline float* value_ptr (const mat4x3& a) { return (float*)a.v; }

const inline double* value_ptr(const dmat2& a)   { return (double*)a.v; }
const inline double* value_ptr(const dmat3& a)   { return (double*)a.v; }
const inline double* value_ptr(const dmat4& a)   { return (double*)a.v; }
const inline double* value_ptr(const dmat2x3& a) { return (double*)a.v; }
const inline double* value_ptr(const dmat2x4& a) { return (double*)a.v; }
const inline double* value_ptr(const dmat3x2& a) { return (double*)a.v; }
const inline double* value_ptr(const dmat3x4& a) { return (double*)a.v; }
const inline double* value_ptr(const dmat4x2& a) { return (double*)a.v; }
const inline double* value_ptr(const dmat4x3& a) { return (double*)a.v; }
